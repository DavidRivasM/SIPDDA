                ...
                {!this.state.postSubmitted ?
                    (
                        ...
                        <div>
                            ...
                            <PDFDownloadLink
                                document={<ProductoPortadaEnvioDocumentos parroquia={this.state.parroquia} nombreParte={this.state.nombreParte} nombreActor={this.state.nombreActor} nombreConvenida={this.state.nombreConvenida}  tel={this.state.tel} cura={this.state.cura} email={this.state.email} web={this.state.web} image={this.state.image} codigo={this.state.codigo} />}
